...
**FR-18:** Date parsing: input `DDMM/HRMN` or `DDMM/HR:MN`, stored as ISO `YYYY-MM-DD HH:MM:SS`; year inferred as current unless the resulting date is in the future, in which case the previous year is assumed.
