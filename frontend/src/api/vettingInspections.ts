...
export const updateVettingInspection = (vesselId: number, inspectionId: number, payload: VettingInspectionCreate) =>
  apiPut<VettingInspection>(`/vessels/${vesselId}/vetting-inspections/${inspectionId}`, payload)
